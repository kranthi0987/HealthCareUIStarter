    ...
    editCall(row) {
        ...
        dialogRef.afterClosed().subscribe((result) => {
            if (result === 1) {
                ...
                this.exampleDatabase.dataChange.value[foundIndex] = this.doctorsService.getDialogData();
...
], AlldoctorsComponent.prototype, "paginator", void 0);
__decorate([
    ViewChild(MatSort, { static: true }),
    __metadata("design:type", MatSort)
], AlldoctorsComponent.prototype, "sort", void 0);
__decorate([
    ViewChild('filter', { static: true }),
    __metadata("design:type", ElementRef)
], AlldoctorsComponent.prototype, "filter", void 0);
AlldoctorsComponent = __decorate([
    Component({
...
//# sourceMappingURL=alldoctors.component.js.map