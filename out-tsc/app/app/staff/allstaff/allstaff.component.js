    ...
    editCall(row) {
        ...
        dialogRef.afterClosed().subscribe((result) => {
            if (result === 1) {
                ...
                this.exampleDatabase.dataChange.value[foundIndex] = this.staffService.getDialogData();
...
], AllstaffComponent.prototype, "paginator", void 0);
__decorate([
    ViewChild(MatSort, { static: true }),
    __metadata("design:type", MatSort)
], AllstaffComponent.prototype, "sort", void 0);
__decorate([
    ViewChild('filter', { static: true }),
    __metadata("design:type", ElementRef)
], AllstaffComponent.prototype, "filter", void 0);
AllstaffComponent = __decorate([
    Component({
...
//# sourceMappingURL=allstaff.component.js.map